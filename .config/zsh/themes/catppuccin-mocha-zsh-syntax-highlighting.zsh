...
## Classes
## Comments
ZSH_HIGHLIGHT_STYLES[comment]='fg=#9399b3,italic'
## Constants
## Entitites
## Functions/methods
...
ZSH_HIGHLIGHT_STYLES[autodirectory]='fg=#94e2d5,italic'
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=#fab387'
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=#fab387'
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]='fg=#cba6f7'
ZSH_HIGHLIGHT_STYLES[back-quoted-argument-unclosed]='fg=#cba6f7,underline'
## Keywords
## Built ins
...
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-unquoted]='fg=#f5c2e7'
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-quoted]='fg=#f5c2e7'
...
ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]='fg=#a6e3a1,underline'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=#a6e3a1'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument-unclosed]='fg=#a6e3a1,underline'
ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#a6e3a1'
## Variables
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#f5c2e7'
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]='fg=#f5c2e7,underline'
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]='fg=#f5c2e7'
ZSH_HIGHLIGHT_STYLES[assign]='fg=#cdd6f4'
ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#cdd6f4'
ZSH_HIGHLIGHT_STYLES[numeric-fd]='fg=#fab387'
## No category relevant in spec
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#eba0ac,underline'
